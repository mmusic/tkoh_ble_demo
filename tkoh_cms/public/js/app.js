...
function checkURL() {
    ...
    if (url1) {
        ...
        $('nav li:has(a[href="' + 'http://127.0.0.1/tkoh_cms/' + url1 + '"])')
            .addClass("active");
        ...
        if (url2){
        // match the url and add the active class
        $('nav li:has(a[href="' + 'http://127.0.0.1/tkoh_cms/' + url1 + '/' + url2 + '"])')
            .addClass("active");
        }
    } else {
        $('nav li.active')
            .removeClass("active");
        // match the url and add the active class
        $('nav li:has(a[href="http://127.0.0.1/tkoh_cms"])')
            .addClass("active");
        title = ($('nav a[href="http://127.0.0.1/tkoh_cms"]')
            .attr('title'));
        document.title = (title || document.title);
    }
}
